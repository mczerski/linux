...
static int ltc2952_poweroff_init(struct platform_device *pdev)
{
	...
	if (!of_property_read_u32(pdev->dev.of_node, "trigger-delay-ms", &trigger_delay_ms))
		data->trigger_delay = ktime_set(trigger_delay_ms / MSEC_PER_SEC, (trigger_delay_ms % MSEC_PER_SEC) * NSEC_PER_MSEC);
